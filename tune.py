...
from utils import AverageMeter, load_model_weights
...
if __name__ == '__main__':
	...
	parser.add_argument('--dataset', default='reside', type=str, help='dataset to be used for training / validation')
	...
	train_dataset = PairLoader(data_config.train_path, 'train', setting.patch_size, setting.edge_decay)
	...
	val_dataset = PairLoader(data_config.test_path, "valid", data_config.test_size)
